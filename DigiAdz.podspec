...
Pod::Spec.new do |s|
    ...
    s.name         = "DigiAdz"
    s.version      = "3.0.0"
    s.summary      = "DigiAdz framework for Ads"
    ...
    s.description  = "A much much longer description of DigiAdz."
    ...
    s.source       = { :git => "https://github.com/ketandhoka/test.git"}
